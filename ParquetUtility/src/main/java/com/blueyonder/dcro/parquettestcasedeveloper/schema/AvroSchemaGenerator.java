package com.blueyonder.dcro.parquettestcasedeveloper.schema;
...
public class AvroSchemaGenerator {
	...
	public  Schema generateAvroSchema(ParquetGrid entityDef) {
		...
		int size = entityDef.getColumnsDetail().length;
		int i = 0;
		
		for (int j = 0 ;j<size;j++) {
			GridColumn gridColumn = entityDef.getColumnsDetail()[j];
			// opening field
