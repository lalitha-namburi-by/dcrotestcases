...
try:
    ...
    #print(data)
    orderheader_sql_query = "select orderid,arrivdate from orderheader union select orderid,arrivdate from lrr_proj_orderheader"
...
order_place_date_folder = '2021-06-28'
timestamp_folder='1626197849'
